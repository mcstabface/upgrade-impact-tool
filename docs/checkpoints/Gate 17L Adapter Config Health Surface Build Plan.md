# Gate 17L Adapter Config Health Surface Build Plan
...
- report adapter config diagnostics in `/health`,
- report missing config as local-policy default,
- report invalid config errors,
- report explicitly configured OIDC as health-only,
- keep live adapter reported as local policy,
- keep endpoint integration disabled.

Out of scope:

- live adapter switching,
- OIDC enablement,
- mutation-path behavior change,
- finalization.
